package fr.tenebrae.entityregistrer.v1_7_R3;
...
final public class CustomRegistry {
	...
	protected static boolean loadEntity(NBTTagCompound nbt, World w) {
		...
		try {
			...
			final net.minecraft.server.v1_7_R3.World nmsW = ((CraftWorld)w).getHandle();
			...
			e.setPositionRotation(pos.d(0), pos.d(1), pos.d(2), rot.e(0), rot.e(1));
