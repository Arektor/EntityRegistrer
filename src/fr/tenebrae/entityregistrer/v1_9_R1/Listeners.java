package fr.tenebrae.entityregistrer.v1_9_R1;
...
final public class Listeners implements Listener {
	...
	public void onChunkUnload(final ChunkUnloadEvent evt) {
		...
		for (org.bukkit.entity.Entity e : c.getEntities()) {
			...
			if (nmsEntity instanceof EntityInsentient) if (CustomRegistry.registryEntries.containsKey(nmsEntity.s(nmsEntity))) CustomRegistry.saveEntity((EntityInsentient) nmsEntity);
		}
	}
}
